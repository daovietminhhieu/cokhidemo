          ...
          <div className="grid-products" style={{ 
            ...
            {featuredProductsList.map((product, idx) => (
              ...
              >
                ...
                <h3 style={{ fontSize: isMobile ? "0.85rem" : "1.1rem", fontWeight: 600, color: "white", marginBottom: '0.5rem', height: isMobile ? '2.4rem' : '2.8rem', overflow: 'hidden' }}>
                  {language === "vi" ? (product.name_vi || product.name) : product.name}
                </h3>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: isMobile ? "0.5rem" : "1rem" }}>
